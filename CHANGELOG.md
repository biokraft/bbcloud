...
- *(skill)* add bbc-report-bug for filing bb bugs upstream ([#48](https://github.com/biokraft/bbcloud/pull/48))

### Fixed

- *(auth)* tell users about the repo and project scopes at login ([#47](https://github.com/biokraft/bbcloud/pull/47))
